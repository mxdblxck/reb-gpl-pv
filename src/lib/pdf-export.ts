  ...
  for (let i = 0; i < results.length; i++) {
    ...
    autoTable(doc, {
      ...
      body: [
        ...
        ["Énergie Requise", formatWh(battery.capacityWh), `À ${params.systemVoltage} V nominal`],
        ...
        ["Branches Parallèles", `${battery.parallelBranches}`, `⌈${battery.capacityAh.toFixed(0)} / ${params.unitaryBatteryCapacity}⌉`],
