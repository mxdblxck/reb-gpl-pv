...
const SITE_PRESETS: Record<string, { name: string; power: number; hours: number; quantity: number }[]> = {
  BVS1: [
    { name: "RTU cabinet – Alim. continue", power: 136.8, hours: 24, quantity: 1 },
    { name: "RTU cabinet – Charge laptop", power: 150, hours: 1, quantity: 1 },
    { name: "TELECOM cabinet – Equip. 24h", power: 107.17, hours: 24, quantity: 1 },
    { name: "TELECOM cabinet – Ventilation", power: 60, hours: 6, quantity: 1 },
    { name: "TELECOM cabinet – Éclairage", power: 11, hours: 1, quantity: 1 },
    { name: "SDV-01 – Moteur", power: 392, hours: 0.1, quantity: 1 },
    { name: "SDV-01 – Électronique", power: 70, hours: 24, quantity: 1 },
    { name: "CPCU – Protection cathodique", power: 240, hours: 24, quantity: 1 },
    { name: "L.BATT & AUX – Extracteur + Écl.", power: 200, hours: 1, quantity: 1 },
  ],
  BVS2: [
    { name: "RTU cabinet – Alim. continue", power: 136.8, hours: 24, quantity: 1 },
    { name: "RTU cabinet – Charge laptop", power: 150, hours: 1, quantity: 1 },
  ...
  TA: [
    { name: "RTU cabinet – Alim. continue", power: 178.9, hours: 24, quantity: 1 },
    { name: "RTU cabinet – Charge laptop", power: 150, hours: 1, quantity: 1 },
    { name: "TELECOM cabinet – Equip. 24h", power: 114.99, hours: 24, quantity: 1 },
    { name: "TELECOM cabinet – Ventilation", power: 60, hours: 6, quantity: 1 },
    { name: "TELECOM cabinet – Éclairage", power: 11, hours: 1, quantity: 1 },
    { name: "CPCU – Protection cathodique", power: 240, hours: 24, quantity: 1 },
    { name: "SDV-02 – Moteur", power: 392, hours: 0.1, quantity: 1 },
    ...
    { name: "D-M – Filtration + Débitmètre", power: 18, hours: 24, quantity: 1 },
    { name: "L.BATT & AUX – Extracteur + Écl.", power: 200, hours: 1, quantity: 1 },
  ],
};
