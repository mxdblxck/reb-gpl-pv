      ...
      <section className="relative pt-20 sm:pt-24 pb-12 sm:pb-5 px-4 sm:px-6 overflow-hidden">
        ...
        <motion.div
          ...
          <a
            ...
            className="bg-card border border-border rounded-xl p-2 sm:p-4 text-center shadow-sm hover:border-primary/50 hover:shadow-md transition-all cursor-pointer group block min-h-[70px] sm:min-h-auto"
            title={`${stat.label}\n${stat.sub}`}>
            
              <div className="text-[10px] sm:text-xl font-bold text-primary group-hover:text-primary/80 transition-colors">{stat.value}</div>
              <div className="text-[8px] sm:text-xs font-medium text-foreground mt-1">
                {stat.label}
              </div>
              <div className="text-[7px] sm:text-xs text-muted-foreground mt-1">
                {stat.sub}
              </div>
